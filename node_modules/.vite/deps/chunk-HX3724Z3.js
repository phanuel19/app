...
} from "./chunk-DB7F5FVF.js";
import {
  require_react_dom
} from "./chunk-MVRAC76T.js";
import {
  useDefaultProps
} from "./chunk-YGVJQT35.js";
import {
  useTheme,
  useThemeProps
} from "./chunk-SCKQYGGS.js";
import {
...
var useOnce = (effect2) => (0, import_react6.useEffect)(effect2, emptyDeps);
var emptyDeps = [];
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React58.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React58.useMemo(() => {
...
function LegendPerItem(props) {
  ...
  const theme = useTheme();
  const drawingArea = useDrawingArea();
  const labelStyle = React63.useMemo(
  ...
  const padding = React63.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React63.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React63.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React63.useMemo(() => {
...
//# sourceMappingURL=chunk-HX3724Z3.js.map
